...
if __name__ == "__main__":
    from lib.single_domain_crawler import SingleDomainCrawler
    ...
    parser.add_argument("--max-depth", type=int, required=True, help="Maksimum tarama derinliği (URL hiyerarşisi)")
    ...
    p_info(f"Maksimum tarama derinliği: {max_depth}")
